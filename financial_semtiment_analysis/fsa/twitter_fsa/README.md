## Financial Sentiment Analysis for analysing market signals
...
**Data Processing, Model Training and Evaluation**: Pandas, Hugging Face, Scikit-learn, Hyperopt

### Data & EDA

The project uses the zeroshot/twitter-financial-news-sentiment dataset, consisting of 9,543 training and 1,910 validation samples.
...
| Metric | Reason | Baseline (TF-IDF + LogReg) | PEFT - Distilbert | Improvement |
| :--- | :--- | :--- | :--- | :--- |
| **F1 - Weighted** | Mimics real-world performance (Neutral majority) | 0.808 | 0.8685 | +7.48% |
| **F1 - Macro** | Ensures identification of rare Bearish/Bullish signals | 0.751 | 0.8220 | +9.45% |
...
1) Using Domain Specific Models: Further fine-tuning the model on domain specif corpus to better handle jargons like “Dumping Virus Hedges”.

2) Real-time API: Transitioning the model into a streaming service for live market monitoring.
